  ...
  return (
    <section id="education" ref={sectionRef} className="py-20 bg-white dark:bg-gray-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-10 left-10 w-32 h-32 bg-blue-200 dark:bg-blue-900 rounded-full opacity-10 animate-bounce" />
        <div className="absolute top-1/2 left-1/4 w-24 h-24 bg-green-200 dark:bg-green-900 rounded-full opacity-10 animate-pulse" style={{ animationDelay: '1s' }} />
      </div>
