...
const Skills = () => {
  ...
  return (
    <section
      id="skills"
      ref={sectionRef}
      className="py-8 sm:py-12 lg:py-16 bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-slate-900 dark:to-black relative overflow-hidden"
    >
      {/* Background Elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className={`flex justify-center transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
          ...
          >
            ...
            >
              <div className="relative bg-white dark:bg-gray-900 rounded-lg sm:rounded-xl lg:rounded-2xl p-3 sm:p-4 lg:p-6 shadow-2xl border border-gray-200 dark:border-gray-700">
                {/* Keyboard Header */}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 max-w-6xl mx-auto">
            {Object.entries(skillsData).map(([categoryKey, category]) => {
              ...
              return (
                <div
                  key={categoryKey}
                  className="relative h-40 sm:h-48 lg:h-56 cursor-pointer group"
